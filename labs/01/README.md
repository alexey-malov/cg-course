...
##### Бонус 30 баллов за возможность таскания картинки при помощи мыши

Пользователь должен иметь возможность «таскать» картинку при помощи мыши методом drag-and-drop.
Область захвата картинки не должна выходить за пределы ограничивающего прямоугольника. Опционально можно реализовать захват только за видимую часть объектов.
