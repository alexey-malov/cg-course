...
CSimpleDoc::CSimpleDoc() noexcept
{
...
void CSimpleDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CSimpleDoc::InitializeSearchContent()
{
...
void CSimpleDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
