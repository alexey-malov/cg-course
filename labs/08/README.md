...
Прежде всего, нужно установить эту библиотеку, после распаковки архива с файлами WTL, дальнейший процесс установки распадается на два этапа: копирование файлов и настройка путей.

**Копирование файлов**

В скачанном архиве три каталога: Include, AppWiz и Samples. Каталог Include содержит файлы, составляющие библиотеку WTL. Поскольку она широко использует шаблоны языка C++, вся её реализация содержится в заголовочных файлах.
В каталоге AppWiz содержится WTL App Wizard, предназначенный для создания заготовок приложений на базе WTL. Местонахождение файла визарда более критично: чтобы он был успешно обнаружен интегрированной средой, его необходимо разместить в каталоге %Visual Studio%\Common\MSDev98\Template.
Что касается примеров из каталога Samples, можно разместить их где угодно.
...
Чтобы указать путь к файлам WTL, нужно открыть Properties/ C/C++ / General, в поле Additional Include Directories указать каталог, в котором скопированы файлы WTL.
