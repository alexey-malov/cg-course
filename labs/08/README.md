...
3) Цикл выборки сообщений. Функция SDL_WaitEvent() является аналогом функции GetMessage() Win API, выполняющая ожидание события в очереди сообщений. Выход из цикла происходит при получении события SDL_QUIT, являющимся сигналом для выхода из
   приложения.
