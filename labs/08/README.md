...
![image](images/paraboloid1.emf)

![image](images/paraboloid2.emf)

Создать с использованием данного геометрического объекта композицию наподобие:

![image](images/composition.emf)
...
![image](images/Elimination of gradation.png)
